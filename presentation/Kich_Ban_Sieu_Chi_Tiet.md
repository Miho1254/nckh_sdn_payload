...
*(Tối ưu hóa Điều phối SDN bằng Mô hình Học Tăng cường Offline TFT-CQL Actor-Critic)*
**Người trình bày:** Đặng Quang Hiển (S28-67CNTT)
**Thời lượng chuẩn:** ~12-15 phút
**Mục tiêu:** Gây ấn tượng mạnh với Hội đồng Khoa học về tính cấp thiết, độ khó logic của thuật toán AI gai góc (TFT-CQL Actor-Critic) và các kết quả thực nghiệm trực quan thuyết phục.
...
| 01:00 - 03:00 | **Slide 2 & 3** | Kiến trúc SDN & Cấu tạo "Não bộ" TFT-CQL. Nhấn mạnh Hàm phần thưởng. |
...
#### Slide 3: Mô hình Lõi: TFT-CQL Actor-Critic (02:15 - 03:30)
- **Hành động & Cử chỉ:** Chỉ tay dứt khoát vào 2 hộp TFT và Actor-Critic. Chuyển tay sang khung "Hàm Phần thưởng" bên phải. (Phần này rất ghi điểm với dân kỹ thuật).
- **Lời thoại:**
  > "Thưa Hội đồng, 'linh hồn' của toàn bộ hệ thống này là mô hình AI kết hợp có tên **TFT-CQL Actor-Critic**. Nó sở hữu 2 siêu năng lực:
  > 
  ...
  > 
  > Hai là mạng **Actor-Critic với CQL**. Từ dự báo của TFT, Actor-Critic sẽ vào vai người ra lệnh điều phối (Action). Làm sao Actor-Critic biết điều phối đúng hay sai? Nhóm em đã thiết kế một **Hàm Phần Thưởng (Reward Function)** cốt lõi:
...
- **Lời thoại:**
  > "Càng ấn tượng hơn là khi cố tình tạo bẫy nghẽn mạng do có kịch bản dội bom. Mạng truyền thống tiếp tục lùa truy cập vào nút đã chết. Còn CQL Actor-Critic thì ngay lập tức nhận hình phạt âm, nó tự cắn đuôi và né hoàn toàn máy chủ đó ra khỏi con đường định tuyến."
...
- **Lời thoại:**
  > "Để đúc kết lại, Nghiên cứu đã chứng minh: Kiến trúc SDN kết hợp mô hình học AI TFT-CQL Actor-Critic là lối đi tân tiến thay đổi lịch sử Load Balancer cổ điển. AI trong nhóm em đã tự nhận diện băng thông máy móc, tự dự báo đám đông và tự nắn dòng tải để cứu hệ thống.
  > 
