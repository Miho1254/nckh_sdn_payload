...
🎯 **Mục tiêu:** Thuyết phục Hội đồng về tính ưu việt của mô hình AI (TFT-DQN) trong việc tự động điều phối lưu lượng mạng SDN thay vì các thuật toán truyền thống.

| Phần | Nội dung | Số phút |
|---|---|---|
| **P1** | Giới thiệu & Đặt vấn đề (Tại sao cần AI?) | 2 phút |
| **P2** | Giải pháp đề xuất (SDN + TFT-DQN + Topology) | 2 phút |
...
**[Slide 3: Mô hình AI TFT-DQN (Lõi hệ thống)]**
Và "trái tim" của hệ thống này chính là mô hình Học Tăng Cường (Reinforcement Learning) tên là **TFT-DQN**. Mô hình kết hợp 2 thành tố chính:
...
2. Thứ hai, mạng **DQN** dùng chính dự báo đó để ra quyết định chia cục traffic hiện tại vào các server dựa trên **Hàm Phần Thưởng (Reward Function)**. 
...
1. **Kịch bản 1 (Gradual Shift):** Lưu lượng tăng dần đều, dùng để train cho AI quen cảm giác.
2. **Kịch bản 2 (Predictable Ramping):** Mô phỏng thi trực tuyến, sinh viên vào lác đác từng lớp một.
3. **Kịch bản 3 (Flash Crowd):** Cơn lốc truy cập (Ngày mở đăng ký) – 1.000 user ập thẳng vào server trong 2 phút.
4. **Kịch bản 4 (Targeted Congestion):** Bị tấn công / Nghẽn có chủ đích – nhắm thẳng vào làm tê liệt một máy duy nhất.
...
Như quý thầy cô thấy, ở 2 kịch bản mạng dễ đoán (*Tăng tải dần đều* và *Ramping*), thuật toán chia theo trọng số tĩnh thông thường (WRR) vẫn hoạt động rất tốt. 
Tuy nhiên, khi đối diện với 2 kịch bản "sốc hông" là *Đám đông bùng phát (Flash Crowd)* và *Nghẽn có mục tiêu*, thì công nghệ cũ vỡ trận. Chỉ duy nhất mô hình AI của hệ thống xuất sắc vượt quá sự mong đợi, duy trì độ công bằng tốt nhất. Cụ thể nó vận hành ra sao? Em xin mời hội đồng xem kịch bản thứ 3: Đám đông bùng phát.

**[Slide 7: Phân bổ tải - Flash Crowd] - (Tương ứng: P1_phan_bo_tai_flash_crowd.png)**
...
**[Slide 8: Phân bổ tải - Targeted Congestion] - (Tương ứng: P1_phan_bo_tai_targeted_congestion.png)**
*`[Chuyển slide]`* Sự thông minh của mô hình càng minh chứng rõ hơn ở kịch bản rủi ro: "Nghẽn cực đoan" do sự cố hoặc tấn công nhắm thẳng vào máy số 7.
...
**[Slide 9: Tốc độ xử lý (Throughput) - Flash Crowd] - (Tương ứng: P3_toc_do_flash_crowd.png)**
...
**[Slide 10: Thời gian suy luận AI] - (Tương ứng: P5_suy_luan_flash_crowd.png)**
...
Tóm lại, thông qua kiến trúc mạng ảo hóa SDN, thực nghiệm chứng minh rằng mô hình TFT-DQN của chúng em đã thay đổi quy luật điều phối truyền thống. Bằng cơ chế học tăng cường có phần thưởng, hệ thống tự định hình được quy mô tài nguyên và lập tức né dòng tải khỏi máy chết.
