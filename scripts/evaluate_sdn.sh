...
echo -e "  1) ${CYAN}flash_crowd.yml${NC}       (Con loc truy cap dot ngot)"
echo -e "  2) ${CYAN}predictable_ramping.yml${NC} (Tang truong du doan duoc)"
...
echo -e "${GREEN}=================================================================${NC}"
# Chay Mininet
docker exec -it nckh-sdn-mininet bash -c "cd /work && SCENARIO=$SCENARIO LB_ALGO=$ALGO python3 run_lms_mininet.py"
